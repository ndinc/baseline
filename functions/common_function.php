...
class SnsBtns {
  ...
  private function get_facebook_html(){
    $html = '<span class="facebook">
      <div class="fb-like" '.(isset($this->url)? 'data-href="'.$this->url.'"' : '').' data-send="false" data-layout="button_count" data-width="85" data-show-faces="false"></div>
    </span>';
    return $html;
  }
  ...
  private function get_twitter_html(){
    $html = '<span class="twitter">
      <a href="https://twitter.com/share" class="twitter-share-button"'.(isset($this->url)? 'data-url="'.$this->url.'"' : '').'" data-count="horizontal" data-lang="ja">ツイート</a>
    </span>';
    return $html;
  }
